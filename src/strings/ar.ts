...
export const ar: Strings = {
  ...
  fasting: {
    title: 'الصيام',
    intro: 'أيام من رمضان لم تصمها، وما عليك من قبل. عدد لا قائمة.',
    notFastingToday: 'لست صائمًا اليوم',
    notFastingTodayDetail: 'يُحفظ يوم واحد تقضيه لاحقًا.',
    recordedToday: 'سُجّل: لست صائمًا اليوم',
    undo: 'اضغط للتراجع',
    summary: (n: number): string => `صيام ${count(n, 'يوم واحد', 'يومين', 'أيام', 'يومًا')} للقضاء`,
    outstanding: (n: number): string => `${count(n, 'يوم واحد', 'يومان', 'أيام', 'يومًا')} عليك`,
    none: 'لا شيء عليك',
    owed: 'عليك من قبل',
    recordMadeUp: 'سجّل يومًا قضيته',
  },
  history: {
    title: 'السجل',
  ...
  language: {
    title: 'اللغة',
    restart:
      'العربية والأردية تُقرآن من اليمين إلى اليسار. التبديل إليهما أو منهما يعيد تشغيل التطبيق أو يطلب منك إعادة فتحه.',
    incomplete: 'الإنجليزية هي الأصل. كل لغة أخرى مسودة ما زالت تنتظر مراجعة متحدث مؤهل.',
    reopenTitle: 'أعد فتح إحسانلي',
    reopenBody:
      'هذه اللغة تُقرأ من اليمين إلى اليسار. أغلق إحسانلي ثم افتحه من جديد ليكتمل التغيير.',
    names: {
      en: 'English',
      ar: 'العربية',
      fr: 'Français',
  ...
  item: {
    ...
    parts: 'ما تقوله',
    partRepeat: (times: number): string => count(times, 'مرة واحدة', 'مرتين', 'مرات', 'مرة'),
