...
export const ar: Strings = {
  ...
  about: {
    ...
    privacyBody:
      'إحسانلي بلا حساب ولا خادم ولا تحليلات. يُستعمل موقعك على الجهاز لحساب أوقات الصلاة ويُخزَّن هنا فقط. وسجل ممارستك يُخزَّن هنا فقط. لا يُرسل شيء إلى أي مكان إلا إن صدّرته أو شاركته أنت.',
    licences: 'بُني بـ',
    licencesBody:
